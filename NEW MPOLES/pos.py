...
glafic.init(0.3, 0.7, -1.0, 0.7, 'NEW MPOLES/', 20.0, 20.0, 21.56, 21.56, 0.01, 0.01, 1, verb = 0)
...
glafic.set_lens(3, 'mpole', 0.261343256161012, 1.0, 20.78, 20.78, 0.0, 0.0, 0.0, 0.0)
glafic.set_lens(4, 'mpole', 0.261343256161012, 1.0, 20.78, 20.78, 0.0, 0.0, 0.0, 0.0)
glafic.set_point(1, 1.0, 20.78, 20.78)

glafic.setopt_lens(1, 0, 0, 1, 1, 1, 1, 1, 0)
glafic.setopt_lens(2, 0, 0, 1, 1, 1, 1, 0, 1)
glafic.setopt_lens(3, 0, 0, 1, 1, 1, 1, 0, 0)
