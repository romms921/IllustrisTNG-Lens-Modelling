...
for i in range(len(centre_x)):
    model_name = f'Test/Shear Shift/SIE_POS_{centre_x[i]}'
    ...
    glafic.set_extend(1, 'point', 1.0, 1.0, centre_x[i], 20.78, 0.0, 0.0, 0.0, 0.0)
    glafic.setopt_lens(1, 0, 0, 0, 0, 0, 0, 0, 0)
    # glafic.setopt_lens(2, 0, 0, 0, 0, 0, 0, 0, 0)
    glafic.setopt_extend(1, 0, 0, 0, 0, 0, 0, 0, 0)
