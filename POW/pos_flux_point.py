...
glafic.init(0.3, 0.7, -1.0, 0.7, 'POW/POW_POS+FLUX', 0.0, 0.0, 5.0, 5.0, 0.04, 0.04, 1, verb = 0)
...
glafic.set_lens(1, 'pow', 0.261343256161012, 1.0, 2.5, 2.5, 4.0e-01, 0.0, 1.39, 2.1) 
