...
glafic.init(0.3, 0.7, -1.0, 0.7, 'C_SIE/SIE_POS+FLUX', 0.0, 0.0, 5.0, 5.0, 0.04, 0.04, 1, verb = 0)
...
glafic.set_lens(1, 'sie', 0.261343256161012, 1.6e+02,  2.5, 2.5, 0.1, 0, 0.4, 0.0)
